...
public class AdminManager {
 ...
 public boolean changePassword(String username, String newPassword) //change other admins password functionalities for super admins.
    {
        if(Validation.isUsernameUnique(username, adminList)){
            System.out.println("That username does not exist.");
        }
    ...
    String displayAdmins() //display all admins in adminlist + their type
    {
        int iteration = 1;
        for(Admin admin : adminList)
        {
