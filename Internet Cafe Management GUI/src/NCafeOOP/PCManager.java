...
public class PCManager {
    ...
    void listPC(int id)
    {
        if(Validation.isPcIdUnique(id, pcs)){
            ...
            JOptionPane.showMessageDialog(null, "A PC with that ID has already exist.");
    ...
    public PC findPC(int id)
    {
        ...
        if(!found){
            ...
            JOptionPane.showMessageDialog(null, "A PC with that ID is not found.");
        }
        return null;
    }
    ...
    public void occupyPC(PC pc, long duration) {
        if (!pc.getAvailability()) {
            ...
            JOptionPane.showMessageDialog(null, "PC " + pc.getId() + " is already occupied.");
        ...
        JOptionPane.showMessageDialog(null, "PC " + pc.getId() + " is now occupied.");
    ...
    public void logoutPC(PC pc) {
        ...
        JOptionPane.showMessageDialog(null, "Customer logged out from PC " + pc.getId());
        ...
        availableTimer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                JOptionPane.showMessageDialog(null, "PC " + pc.getId() + " is now available.");
